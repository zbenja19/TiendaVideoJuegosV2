...
public class PlataformaModelAssembler implements  RepresentationModelAssembler<PlataformaDTO, EntityModel<PlataformaDTO>>{
    ...
    public EntityModel<PlataformaDTO> toModel(PlataformaDTO plataforma){
        ...
        linkTo(methodOn(PlataformaController.class).listar()).withRel("listar"),
        linkTo(methodOn(PlataformaController.class).guardar(null)).withRel("guardar"),
        linkTo(methodOn(PlataformaController.class).eliminar(plataforma.getIdPlataforma())).withRel("eliminar"),
        linkTo(methodOn(PlataformaController.class).actualizar(plataforma.getIdPlataforma(),null)).withRel("actualizar")
        );
    }
}
